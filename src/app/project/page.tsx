...
const projects: Project[] = [
    {
        ...
        fullDescription: "An automated cleaning system for solar panels controlled via a web interface. The robot, powered by ESP8266, moves across the panel surface to remove debris, maximizing energy efficiency. It features a Python (Flask) backend handling MQTT for robot communication and WebSockets for real-time status updates to a React dashboard.",
        category: "IoT",
    ...
    },
    {
        ...
        fullDescription: "A comprehensive disaster mitigation project that monitors water levels in real-time. By utilizing ultrasonic sensors and ESP8266, data is streamed to a central server. This project emphasizes Server Technology principles, including efficient data handling, real-time alerting systems, and database optimization for historical analysis.",
        category: "IoT",
        tags: ["ESP8266", "Ultrasonic", "Server Tech", "MQTT"],
