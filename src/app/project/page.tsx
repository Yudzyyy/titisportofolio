...
const projects: Project[] = [
    ...
    },
    {
        ...
        fullDescription: "Proyek sistem monitoring ketinggian air berbasis IoT untuk deteksi dini banjir menggunakan ESP32, berbagai sensor lingkungan, dan backend Node.js. Sistem ini dikelola dengan infrastruktur modern berbasis Docker & Kubernetes serta dilengkapi fitur notifikasi Telegram real-time.",
        category: "IoT",
